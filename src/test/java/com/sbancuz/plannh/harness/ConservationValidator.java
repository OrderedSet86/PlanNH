...
/**
 * Independent conservation check over a balance result, following the flowv2 rule of never
 * trusting a solver's status code: every solution is validated against the graph itself.
 *
 * <p>
